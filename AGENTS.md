...
- Keep token estimation behind a replaceable interface with explicit confidence. Estimates must be conservative, and approximation uncertainty belongs in the safety reserve.
